...
export const iconSvg = (
  ...
  if (type === "cart") {
    ...
    shape = `<g transform="scale(2.6666667)"><path d="M9 4.94198C6.47561 4.02693 5.129 3.65381 4.39141 4.39141C3.55146 5.23136 4.15187 6.86106 5.3527 10.1205L7.3603 15.5696C7.96225 17.2035 8.26322 18.0204 8.92489 18.1658C9.58656 18.3111 10.2022 17.6955 11.4334 16.4643L12.6361 15.2616L16.5744 19.1999C16.9821 19.6077 17.186 19.8116 17.4135 19.9058C17.7168 20.0314 18.0575 20.0314 18.3608 19.9058C18.5882 19.8116 18.7921 19.6077 19.1999 19.1999C19.6077 18.7921 19.8116 18.5882 19.9058 18.3608C20.0314 18.0575 20.0314 17.7168 19.9058 17.4135C19.8116 17.186 19.6077 16.9821 19.1999 16.5744L15.2616 12.6361L16.4643 11.4334C17.6955 10.2022 18.3111 9.58656 18.1658 8.92489C18.0204 8.26322 17.2035 7.96225 15.5696 7.3603L13 6.41359" fill="${fill}" fill-opacity="0.35" stroke="${accent}" stroke-width="1.1" stroke-linecap="round" stroke-linejoin="round"/></g>`;
    ...
    shape = `<g transform="scale(1.7777778)"><path d="M30.74,15.19a13.66,13.66,0,0,0-6.87-3.83A26,26,0,0,0,18,10.58V5.28A3.4,3.4,0,0,0,14.5,2,3.4,3.4,0,0,0,11,5.28v10L9.4,13.7a3.77,3.77,0,0,0-5.28,0A3.67,3.67,0,0,0,3,16.33a3.6,3.6,0,0,0,1,2.56l4.66,5.52a11.53,11.53,0,0,0,1.43,4,10.12,10.12,0,0,0,2,2.54v1.92a1.07,1.07,0,0,0,1,1.08H27a1.07,1.07,0,0,0,1-1.08v-2.7a12.81,12.81,0,0,0,3-8.36v-6A1,1,0,0,0,30.74,15.19ZM29,21.86a10.72,10.72,0,0,1-2.6,7.26,1.11,1.11,0,0,0-.4.72V32H14.14V30.52a1,1,0,0,0-.44-.83,7.26,7.26,0,0,1-1.82-2.23,9.14,9.14,0,0,1-1.2-3.52,1,1,0,0,0-.23-.59L5.53,17.53a1.7,1.7,0,0,1,0-2.42,1.76,1.76,0,0,1,2.47,0l3,3v3.14l2-1V5.28A1.42,1.42,0,0,1,14.5,4,1.42,1.42,0,0,1,16,5.28v11.8l2,.43V12.59a24.27,24.27,0,0,1,2.51.18V18l1.6.35V13c.41.08.83.17,1.26.28a14.88,14.88,0,0,1,1.53.49v5.15l1.6.35V14.5A11.06,11.06,0,0,1,29,16.23Z" fill="${fill}" fill-opacity="0.2" stroke="${accent}" stroke-width="0.9" stroke-linejoin="round"/><circle cx="18" cy="18" r="2.4" fill="${accent}"/></g>`;
    ...
    shape = `<g transform="scale(2.6666667)"><path d="M20 21V19C20 16.7909 18.2091 15 16 15H15C14.4477 15 14 14.5523 14 14V9C14 7.89543 13.1046 7 12 7V7C10.8954 7 10 7.89543 10 9V18L7.6 14.8C7.22229 14.2964 6.62951 14 6 14H5.56619C4.70121 14 4 14.7012 4 15.5662V15.5662C4 15.8501 4.07715 16.1286 4.22319 16.372L7 21" fill="none" stroke="${fill}" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.4"/><path d="M12 4V3" fill="none" stroke="${accent}" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.4"/><path d="M18 10L19 10" fill="none" stroke="${accent}" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.4"/><path d="M5 10L6 10" fill="none" stroke="${accent}" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.4"/><path d="M7.34334 5.34309L6.63623 4.63599" fill="none" stroke="${accent}" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.4"/><path d="M16.6567 5.34309L17.3638 4.63599" fill="none" stroke="${accent}" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.4"/><circle cx="12" cy="15" r="2.2" fill="${accent}"/></g>`;

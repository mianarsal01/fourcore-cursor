...
const getPresetHotspot = (preset: string) => {
...
const CURSOR_LIBRARY: CursorCategory[] = [
  {
    ...
    items: [
      ...
      (() => {
        ...
        const defaultAccentColor = "#ff9f1c";
        const hoverColor = "#ffb703";
        const hoverAccentColor = "#ffd60a";
        const base = buildPreviewSvg(
          "icon",
          defaultColor,
          defaultAccentColor,
        ...
        return {
          id: "cartoon-electric",
          name: "Spark Critter",
          imageUrl: "cartoon-electric",
          hoverImageUrl: "cartoon-electric-hover",
          previewSvg: base.markup,
          previewHoverSvg: hover.markup,
          size: 32,
          defaultColor,
      ...
      (() => {
        ...
        return {
          id: "cartoon-explorer",
          name: "Explorer Trail",
          imageUrl: "cartoon-explorer",
          hoverImageUrl: "cartoon-explorer-hover",
          previewSvg: base.markup,
          previewHoverSvg: hover.markup,
          size: 32,
          defaultColor,
      ...
      (() => {
        const defaultColor = "#fb7185";
        const defaultAccentColor = "#111827";
        const hoverColor = "#f43f5e";
        ...
        return {
          id: "cartoon-ninja",
          name: "Ninja Fox",
          imageUrl: "cartoon-ninja",
          hoverImageUrl: "cartoon-ninja-hover",
          previewSvg: base.markup,
          previewHoverSvg: hover.markup,
          size: 32,
          defaultColor,
      ...
      (() => {
        ...
        return {
          id: "cartoon-space",
          name: "Space Pilot",
          imageUrl: "cartoon-space",
          hoverImageUrl: "cartoon-space-hover",
          previewSvg: base.markup,
          previewHoverSvg: hover.markup,
          size: 32,
          defaultColor,
      ...
      (() => {
        ...
        const defaultAccentColor = "#86efac";
        ...
        return {
          id: "cartoon-slime",
          name: "Slime Buddy",
          imageUrl: "cartoon-slime",
          hoverImageUrl: "cartoon-slime-hover",
          previewSvg: base.markup,
          previewHoverSvg: hover.markup,
          size: 32,
          defaultColor,
      ...
      (() => {
        const defaultColor = "#fde047";
        const defaultAccentColor = "#ef4444";
        const hoverColor = "#fbbf24";
        const hoverAccentColor = "#f97316";
        const base = buildPreviewSvg(
          "icon",
          defaultColor,
          defaultAccentColor,
        ...
        return {
          id: "cartoon-emoji-smile",
          name: "Emoji Smile",
          imageUrl: "cartoon-emoji-smile",
          hoverImageUrl: "cartoon-emoji-smile-hover",
          previewSvg: base.markup,
          previewHoverSvg: hover.markup,
          size: 32,
          defaultColor,
      ...
      (() => {
        ...
        return {
          id: "cartoon-emoji-wink",
          name: "Emoji Wink",
          imageUrl: "cartoon-emoji-wink",
          hoverImageUrl: "cartoon-emoji-wink-hover",
          previewSvg: base.markup,
          previewHoverSvg: hover.markup,
          size: 32,
          defaultColor,
      ...
      (() => {
        ...
        return {
          id: "cartoon-emoji-love",
          name: "Emoji Love",
          imageUrl: "cartoon-emoji-love",
          hoverImageUrl: "cartoon-emoji-love-hover",
          previewSvg: base.markup,
          previewHoverSvg: hover.markup,
          size: 32,
          defaultColor,
  ...
  },
  {
    ...
    items: [
      (() => {
        ...
        const defaultAccentColor = "#60a5fa";
        const hoverColor = "#111827";
        const hoverAccentColor = "#2563eb";
        const base = buildPreviewSvg(
          "icon",
          defaultColor,
          defaultAccentColor,
        ...
        return {
          id: "modern-clean-line",
          name: "Clean Line",
          imageUrl: "modern-clean-line",
          hoverImageUrl: "modern-clean-line-hover",
          previewSvg: base.markup,
          previewHoverSvg: hover.markup,
          size: 32,
          defaultColor,
      ...
      (() => {
        ...
        return {
          id: "modern-glass",
          name: "Glassmorph",
          imageUrl: "modern-glass",
          hoverImageUrl: "modern-glass-hover",
          previewSvg: base.markup,
          previewHoverSvg: hover.markup,
          size: 32,
          defaultColor,
      ...
      (() => {
        ...
        const hoverColor = "#14b8a6";
        const hoverAccentColor = "#a7f3d0";
        const base = buildPreviewSvg(
          "icon",
          defaultColor,
          defaultAccentColor,
        ...
        return {
          ...
          name: "Neo-Tech",
          imageUrl: "modern-neo",
          hoverImageUrl: "modern-neo-hover",
          previewSvg: base.markup,
          previewHoverSvg: hover.markup,
          size: 32,
          defaultColor,
      ...
      (() => {
        ...
        const defaultAccentColor = "#cbd5e1";
        const hoverColor = "#f1f5f9";
        const hoverAccentColor = "#94a3b8";
        const base = buildPreviewSvg(
          "icon",
          defaultColor,
          defaultAccentColor,
        ...
        return {
          id: "modern-paper",
          name: "Paper Cut",
          imageUrl: "modern-paper",
          hoverImageUrl: "modern-paper-hover",
          previewSvg: base.markup,
          previewHoverSvg: hover.markup,
          size: 32,
          defaultColor,
      ...
      (() => {
        const defaultColor = "#fca5a5";
        const defaultAccentColor = "#fdba74";
        const hoverColor = "#fda4af";
        ...
        return {
          id: "modern-clay",
          name: "Soft Clay",
          imageUrl: "modern-clay",
          hoverImageUrl: "modern-clay-hover",
          previewSvg: base.markup,
          previewHoverSvg: hover.markup,
          size: 32,
          defaultColor,
      ...
      (() => {
        ...
        const defaultAccentColor = "#f5d06a";
        const hoverColor = "#111827";
        const hoverAccentColor = "#f8e27a";
        const base = buildPreviewSvg(
          "icon",
          defaultColor,
          defaultAccentColor,
        ...
        return {
          id: "modern-luxe",
          name: "Mono Luxe",
          imageUrl: "modern-luxe",
          hoverImageUrl: "modern-luxe-hover",
          previewSvg: base.markup,
          previewHoverSvg: hover.markup,
          size: 32,
          defaultColor,
      ...
      (() => {
        ...
        return {
          id: "modern-chroma",
          name: "Chromatic",
          imageUrl: "modern-chroma",
          hoverImageUrl: "modern-chroma-hover",
          previewSvg: base.markup,
          previewHoverSvg: hover.markup,
          size: 32,
          defaultColor,
      ...
      (() => {
        const defaultColor = "#fb7185";
        const defaultAccentColor = "#fda4af";
        const hoverColor = "#f43f5e";
        ...
        return {
          id: "modern-studio",
          name: "Studio Tools",
          imageUrl: "modern-studio",
          hoverImageUrl: "modern-studio-hover",
          previewSvg: base.markup,
          previewHoverSvg: hover.markup,
          size: 32,
          defaultColor,
      ...
      (() => {
        ...
        return {
          id: "modern-travel",
          name: "Travel Minimal",
          imageUrl: "modern-travel",
          hoverImageUrl: "modern-travel-hover",
          previewSvg: base.markup,
          previewHoverSvg: hover.markup,
          size: 32,
          defaultColor,
  ...
  },
  {
    ...
    items: [
      (() => {
        ...
        const defaultAccentColor = "#22d3ee";
        const hoverColor = "#f472b6";
        const hoverAccentColor = "#60a5fa";
        const base = buildPreviewSvg(
          "icon",
          defaultColor,
          defaultAccentColor,
      ...
      (() => {
        ...
        const defaultAccentColor = "#f472b6";
      ...
      (() => {
        ...
        const defaultAccentColor = "#a3e635";
        const hoverColor = "#f59e0b";
        const hoverAccentColor = "#fbbf24";
        const base = buildPreviewSvg(
          "icon",
        ...
        return {
          ...
          name: "Neon Orbit",
          imageUrl: "neon-orbit",
          hoverImageUrl: "neon-orbit-hover",
          previewSvg: base.markup,
          previewHoverSvg: hover.markup,
          size: 32,
          defaultColor,
      ...
      (() => {
        ...
        return {
          ...
          name: "Neon Click",
          imageUrl: "neon-click",
          hoverImageUrl: "neon-click-hover",
          previewSvg: base.markup,
          previewHoverSvg: hover.markup,
          size: 32,
          defaultColor,
      ...
      (() => {
        ...
        return {
          ...
          name: "Neon Punch",
          imageUrl: "neon-punch",
          hoverImageUrl: "neon-punch-hover",
          previewSvg: base.markup,
          previewHoverSvg: hover.markup,
          size: 32,
          defaultColor,
    ...
    items: [
      ...
      (() => {
        ...
        return {
          id: "commerce-travel",
          name: "Travel Vibes",
          imageUrl: "commerce-travel",
          hoverImageUrl: "commerce-travel-hover",
          previewSvg: base.markup,
          previewHoverSvg: hover.markup,
          size: 32,
          defaultColor,
      ...
      (() => {
        const defaultColor = "#a855f7";
        const defaultAccentColor = "#c084fc";
        const hoverColor = "#7c3aed";
        const hoverAccentColor = "#e879f9";
        const base = buildPreviewSvg(
          "icon",
          defaultColor,
          defaultAccentColor,
        ...
        return {
          id: "commerce-music",
          name: "Music Store",
          imageUrl: "commerce-music",
          hoverImageUrl: "commerce-music-hover",
          previewSvg: base.markup,
          previewHoverSvg: hover.markup,
          size: 32,
          defaultColor,
      ...
      (() => {
        ...
        return {
          id: "commerce-bikini",
          name: "Bikini Boutique",
          imageUrl: "commerce-bikini",
          hoverImageUrl: "commerce-bikini-hover",
          previewSvg: base.markup,
          previewHoverSvg: hover.markup,
          size: 32,
          defaultColor,
      ...
      (() => {
        const defaultColor = "#fde047";
        const defaultAccentColor = "#7dd3fc";
        const hoverColor = "#22c55e";
        const hoverAccentColor = "#0ea5e9";
        const base = buildPreviewSvg(
          "icon",
        ...
        return {
          id: "commerce-surf",
          name: "Surf Shop",
          imageUrl: "commerce-surf",
          hoverImageUrl: "commerce-surf-hover",
          previewSvg: base.markup,
          previewHoverSvg: hover.markup,
          size: 32,
          defaultColor,
      ...
      (() => {
        const defaultColor = "#f59e0b";
        const defaultAccentColor = "#7c3aed";
        const hoverColor = "#fcd34d";
        const hoverAccentColor = "#9333ea";
        const base = buildPreviewSvg(
          "icon",
          defaultColor,
          defaultAccentColor,
        ...
        return {
          id: "commerce-jewelry",
          name: "Jewelry Glow",
          imageUrl: "commerce-jewelry",
          hoverImageUrl: "commerce-jewelry-hover",
          previewSvg: base.markup,
          previewHoverSvg: hover.markup,
          size: 32,
          defaultColor,
      ...
      (() => {
        ...
        const defaultAccentColor = "#64748b";
        const hoverColor = "#22c55e";
        const hoverAccentColor = "#0f172a";
        const base = buildPreviewSvg(
          "icon",
        ...
        return {
          id: "commerce-home",
          name: "Home Decor",
          imageUrl: "commerce-home",
          hoverImageUrl: "commerce-home-hover",
          previewSvg: base.markup,
          previewHoverSvg: hover.markup,
          size: 32,
          defaultColor,
  ...
  },
  {
    ...
    items: [
      (() => {
        ...
        const defaultAccentColor = "#bae6fd";
        const hoverColor = "#60a5fa";
        const hoverAccentColor = "#dbeafe";
        const base = buildPreviewSvg(
          "icon",
          defaultColor,
          defaultAccentColor,
        ...
        return {
          id: "season-winter",
          name: "Winter Glow",
          imageUrl: "season-winter",
          hoverImageUrl: "season-winter-hover",
          previewSvg: base.markup,
          previewHoverSvg: hover.markup,
          size: 32,
          defaultColor,
      ...
      (() => {
        ...
        return {
          ...
          imageUrl: "season-valentine",
          hoverImageUrl: "season-valentine-hover",
          previewSvg: base.markup,
          previewHoverSvg: hover.markup,
          size: 32,
          defaultColor,
      ...
      (() => {
        const defaultColor = "#fbbf24";
        const defaultAccentColor = "#fde68a";
        const hoverColor = "#f97316";
        const hoverAccentColor = "#fed7aa";
        const base = buildPreviewSvg(
          "icon",
          defaultColor,
          defaultAccentColor,
        ...
        return {
          id: "season-summer",
          name: "Summer Splash",
          imageUrl: "season-summer",
          hoverImageUrl: "season-summer-hover",
          previewSvg: base.markup,
          previewHoverSvg: hover.markup,
          size: 32,
          defaultColor,
      ...
      (() => {
        ...
        const defaultAccentColor = "#fef08a";
        const hoverColor = "#f97316";
        const hoverAccentColor = "#fde68a";
        const base = buildPreviewSvg(
          "icon",
        ...
        return {
          ...
          imageUrl: "season-halloween",
          hoverImageUrl: "season-halloween-hover",
          previewSvg: base.markup,
          previewHoverSvg: hover.markup,
          size: 32,
          defaultColor,
      ...
      (() => {
        ...
        return {
          id: "season-cyber",
          name: "Cyber Friday",
          imageUrl: "season-cyber",
          hoverImageUrl: "season-cyber-hover",
          previewSvg: base.markup,
          previewHoverSvg: hover.markup,
          size: 32,
          defaultColor,
      ...
      (() => {
        ...
        const defaultAccentColor = "#a7f3d0";
        const hoverColor = "#10b981";
        const hoverAccentColor = "#6ee7b7";
        const base = buildPreviewSvg(
          "icon",
          defaultColor,
          defaultAccentColor,
        ...
        return {
          id: "season-spring",
          name: "Spring Bloom",
          imageUrl: "season-spring",
          hoverImageUrl: "season-spring-hover",
          previewSvg: base.markup,
          previewHoverSvg: hover.markup,
          size: 32,
          defaultColor,
      ...
      (() => {
        ...
        return {
          id: "season-autumn",
          name: "Autumn Harvest",
          imageUrl: "season-autumn",
          hoverImageUrl: "season-autumn-hover",
          previewSvg: base.markup,
          previewHoverSvg: hover.markup,
          size: 32,
          defaultColor,
      ...
      (() => {
        ...
        return {
          id: "season-newyear",
          name: "New Year Spark",
          imageUrl: "season-newyear",
          hoverImageUrl: "season-newyear-hover",
          previewSvg: base.markup,
          previewHoverSvg: hover.markup,
          size: 32,
          defaultColor,
      ...
      (() => {
        ...
        return {
          id: "premium-gaming",
          name: "Gaming Pulse",
          imageUrl: "premium-gaming",
          hoverImageUrl: "premium-gaming-hover",
          previewSvg: base.markup,
          previewHoverSvg: hover.markup,
          size: 32,
          defaultColor,
...
export const action = async ({ request }: ActionFunctionArgs) => {
  ...
  const defaultHotspot = getPresetHotspot(normalized.preset);
  const hoverHotspot = getPresetHotspot(normalized.preset);
...
export default function Index() {
  ...
  useEffect(() => {
    if (fetcher.data?.ok) {
      setToast({ message: "Cursor settings saved", tone: "success" });
    }
    if (fetcher.data?.error) {
      setToast({ message: fetcher.data.error, tone: "error" });
    }
  ...
  return (
    <s-page heading="FourCore Custom Cursor" inlineSize="large">
      <div className={styles.studio}>
        {toast ? (
          <div
            className={`${styles.brandedToast} ${
              toast.tone === "error"
                ? styles.brandedToastError
                : styles.brandedToastSuccess
            }`}
            role="status"
          >
            <span className={styles.brandedToastIcon}>
              {toast.tone === "error" ? "!" : "✓"}
            </span>
